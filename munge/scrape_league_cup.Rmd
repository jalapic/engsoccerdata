...
updated_data <- lapply(year_links, function(link) {
...
```{r}
new_teams <- unique(c(updated_data$home, updated_data$visitor))
old_teams <- unique(c(full_league_cup_data$home, full_league_cup_data$visitor))
```
