#' Belgian league results 1995-2020
#'
#' All results for Scottish soccer games in the top tier
#' from 1995/96 season to 2019/20 season.  Doesn't include
#' playoff games.
#'
#' @format A data frame with 6852 rows and 12 variables:
#' \describe{
