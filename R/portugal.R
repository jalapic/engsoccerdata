#' Portuguese league results 1994-2020
#'
#' All results for Portuguese soccer games in the top tier
#' from 1994/95 season to 2016/20 season.  Doesn't include
#' playoff games.
#'
#' @format A data frame with 7428 rows and 12 variables:
#' \describe{
